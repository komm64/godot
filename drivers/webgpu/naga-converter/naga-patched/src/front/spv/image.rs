...
pub(super) fn patch_comparison_type(
    ...
    // Mixed comparison+regular usage: return false to trigger variable splitting.
    // The caller will create a Depth clone for comparison and a Float clone for regular,
    // allowing proper BGL and sampler pairing in WebGPU.
