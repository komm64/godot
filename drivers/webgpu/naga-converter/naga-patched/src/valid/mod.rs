...
impl Validator {
    ...
    fn validate_impl(
        ...
        // Skip arena handle ordering validation. Our comparison-sampling
        // variable splitting may create forward references (expression A at a
        // lower index references expression B at a higher index). This is
        // semantically valid — the WGSL writer handles it correctly by
        // recursively emitting dependencies. The ordering check is a strict
        // invariant that doesn't affect output correctness.
