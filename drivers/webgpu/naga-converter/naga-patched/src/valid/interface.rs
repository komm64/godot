    ...
    fn validate_impl(
        ...
        match *binding {
            ...
            crate::Binding::Location {
                ...
                // Relaxed: allow non-IO-shareable types (e.g. bool) to pass through.
                // Dawn/WGSL will do its own validation and the WGSL writer will
                // emit the appropriate type. This fixes SPIR-V shaders that pass
                // booleans between stages.
